# Oldschool Runescape Highscore Helper

### About
This application is build to use the "Crystal Math Labs" API (so kudo's to them). The app is build on Polymer v2 so it easy to port it to mobile devices.
